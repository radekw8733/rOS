...
pub const BOOTBOOT_MMIO: usize = 0xfffffffff8000000;  /* memory mapped IO virtual address */
pub const BOOTBOOT_FB: usize = 0xfffffffffc000000;  /* frame buffer virtual address */
pub const BOOTBOOT_INFO: usize = 0xffffffffffe00000;  /* bootboot struct virtual address */
pub const BOOTBOOT_ENV: usize = 0xffffffffffe01000;  /* environment string virtual address */
pub const BOOTBOOT_CORE: usize = 0xffffffffffe02000;  /* core loadable segment start */
